                                ...
                                <tr key={ticket.id || ticket.ticket_reference || `ticket-${index}`} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-center">
                                        <div className="flex justify-center items-center">
                                            <span className={`inline-flex items-center justify-center ${getStatusStyle(ticket.status)}`}>
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-center">
                                        <div className="flex justify-center items-center">
                                            <button 
                                                ...
                                                className="bg-blue-600 text-white px-6 py-1 rounded hover:bg-blue-700 transition-colors font-medium"
                                            >
                                                View
                                            </button>
                                        </div>
                            ...
                            <div className="mt-6">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <button
                                        ...
                                        onClick={() => handleStatusChange(viewingTicket.ticket_id, 'In Progress')}
                                    ...
                                    <button
                                        ...
                                        onClick={() => handleStatusChange(viewingTicket.ticket_id, 'Resolved')}
                                        disabled={updateLoading}
                                    >
                                        Mark as Resolved
                                    </button>
